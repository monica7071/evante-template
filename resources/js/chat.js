...
class ChatManager {
    ...
    showWelcome() {
        setTimeout(() => {
            this.renderMessage(
                'bot',
                'สวัสดีค่ะ ยินดีต้อนรับสู่โครงการ Evante Samui ดิฉันเอวอง ที่ปรึกษาโครงการค่ะ\n\nพร้อมช่วยดูห้องว่าง ราคา โปรโมชั่น นัดชม และคำนวณสินเชื่อค่ะ วันนี้ต้องการให้ช่วยเรื่องอะไรคะ',
                null,
