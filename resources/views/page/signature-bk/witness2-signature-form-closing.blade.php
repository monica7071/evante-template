...
<head>
    ...
    <title>Witness 2 Signature for Closing | {{ $projectName }}</title>
    ...
    <div class="container">
        <div class="signature-container">
            <div class="signature-header">
                <h2>Witness 2 Signature for Closing / ลงชื่อพยาน 2</h2>
                ...
                previewBtn.addEventListener('click', function(e) {
                    ...
                    fetch(downloadUrl, {
                        ...
                        .then(blob => {
                            ...
                            tempLink.href = url;
                            tempLink.setAttribute('download', `Rental_Agreement_${requestId}_Witness2.pdf`);
