...
<head>
    ...
    <title>Witness 1 Signature | {{ $projectName }}</title>
    ...
    <div class="container">
        <div class="signature-container">
            <div class="signature-header">
                <h2>Witness 1 Signature for Booking / ลงชื่อพยาน 1</h2>
                <p>Witness 1 Sign Agreement / พยาน 1 ลงนามข้อตกลง</p>
            ...
            <div class="form-group mb-4">
                ...
                <input type="text" id="witnessName" class="form-control" placeholder="Enter witness name / กรุณากรอกชื่อพยาน" value="{{ $witnessName }}" required>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (previewBtn) {
                previewBtn.addEventListener('click', function(e) {
                    ...
                    const downloadUrl = `/public/generate-print-reservation/${token}`;
                    ...
                    fetch(downloadUrl, {
                        ...
                        .then(blob => {
                            ...
                            tempLink.href = url;
                            tempLink.setAttribute('download', `witness1-reservation-${requestId}.pdf`);
            ...
            document.getElementById('saveButton').addEventListener('click', function() {
                ...
                fetch('{{ route("witness1.signature.save") }}', {
                    method: 'POST',
                    headers: {
