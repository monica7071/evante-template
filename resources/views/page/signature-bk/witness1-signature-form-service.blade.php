...
<head>
    ...
    <title>Witness 1 Signature for Service | {{ $projectName }}</title>
    ...
    <div class="container">
        <div class="signature-container">
            <div class="signature-header">
                <h2>Witness 1 Signature for Service / ลงชื่อพยาน 1</h2>
                ...
                previewBtn.addEventListener('click', function(e) {
                    ...
                    fetch(downloadUrl, {
                        ...
                        .then(blob => {
                            ...
                            tempLink.href = url;
                            tempLink.setAttribute('download', `witness1-service-${requestId}.pdf`);
