...
<head>
    ...
    <title>Witness 2 Signature | {{ $projectName }}</title>
    ...
    <div class="container">
        <div class="signature-container">
            <div class="signature-header">
                <h2>Witness 2 Signature for Booking / ลงชื่อพยาน 2</h2>
                ...
                previewBtn.addEventListener('click', function(e) {
                    ...
                    fetch(downloadUrl, {
                        ...
                        .then(blob => {
                            ...
                            tempLink.href = url;
                            tempLink.setAttribute('download', `witness2-reservation-${requestId}.pdf`);
